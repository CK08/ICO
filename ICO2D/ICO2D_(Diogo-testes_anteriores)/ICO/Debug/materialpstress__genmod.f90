        ...
        MODULE MATERIALPSTRESS__genmod
          INTERFACE 
            SUBROUTINE MATERIALPSTRESS(IPROPS,NODEDOF,NNODES,PROPS,B,   &
     &BLINES,DDISP,STRESS,STRAIN,DSTRAIN,DSTRESS,HARD,MATD)
            ...
            END SUBROUTINE MATERIALPSTRESS
          END INTERFACE 
        END MODULE MATERIALPSTRESS__genmod
