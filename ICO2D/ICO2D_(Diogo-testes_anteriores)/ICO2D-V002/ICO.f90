...
!--------------------------------------------------------------------------------------------------    
    ...
    !FileName = 'Contact_examples/Contact1d'
    !FileName = 'Contact_examples/ContactConv1b'
    !FileName = 'Contact_examples/Multistep2'
    !FileName = 'Contact_examples/Ironing_p2'
    !FileName = 'Contact_examples/PtS_HalfRing_8el_p2q2'
    !FileName = 'Contact_examples/SingleQuad'
    !FileName = 'Contact_examples/PtS_Punch_100el_p2q2'
    !FileName = 'Contact_examples/PtS_PunchFull_392el_p2q2'
    !FileName = 'Contact_examples/Hertz1_p2q2'
    !FileName = 'Contact_examples/Hertz_16x8_Mesh3_p2q2'
    !FileName = 'Contact_examples/Hertz_32x16_p2q2'
    !FileName = 'Contact_examples/ContactPT_Crisfield'
    !FileName = 'Contact_examples/PtS_Tube_40el_p2q2'
    !FileName = 'Contact_examples/Hertz_16x16_Mesh1_Bathe_p2q2'
    !FileName = 'Contact_examples/FlatPunch_16x16_Mesh3_p2q2'
    !FileName = 'Contact_examples/SingleElementQ2'
    !FileName = 'Contact_examples/Cook_4el_p2q2'
...
!                                            call ElQuad9EBBar(nze,Ke,KBar,dispin,Finte)
                                ...
                                if((u_knot(i) .ne. u_knot(i+1)) .and. (v_knot(j) .ne. v_knot(j+1))) then
                                    ...
                                    do k1=1,(p+1)
                                        do k2=1,(q+1)
                                            loc_num = loc_num + 1
                                            do k3=1,nds
                                                GCoords(MP_Conn(nzep,loc_num),k3) = Points0(IEN(nze,loc_num),k3)&
                                                                         + u(MP_conn(nzep,loc_num)*nds-(nds-k3),1)
                                            end do
                ...
                if(ContactPTS == .true. .and. iter .gt. 1)then
                    call PTS_ComputeGap(iter,inc,istp,iLM)
                     ! Teste Diogo (1º contacto)   
                     !call PTS_ComputeGap_testD(iter,inc,istp,iLM)
