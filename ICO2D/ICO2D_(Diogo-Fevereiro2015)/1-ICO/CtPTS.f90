...
!            end if
        ...
        do i=1,ngrv
            ...
            do k1=2,ncp_m+1
                FintLM(ctconn(k1)*nds-1,1) = FintLM(ctconn(k1)*nds-1,1) + &
                        & FLM(ctconn(k1)*nds-1,i)*dispLM(tnodes*nds-nbc+i,1)
                FintLM(ctconn(k1)*nds  ,1) = FintLM(ctconn(k1)*nds  ,1) + &
                        & FLM(ctconn(k1)*nds  ,i)*dispLM(tnodes*nds-nbc+i,1)
            end do
