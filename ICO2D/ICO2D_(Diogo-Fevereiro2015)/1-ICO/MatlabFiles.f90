...
!----------------------------------------------------------------------------------------------
!
! Subroutine that writes a txt of the NURBS structure with all the iterations of each increment
! This file is meant to be read by the matlab ReadNURBSOutput.m
!
