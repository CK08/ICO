...
%         scatter(9.552497077063775e-002,0.918744850782052,50,RGB,'fill','s'), hold on
%         scatter(0.500000000000000,0.905699666269277,50,RGB,'fill','s'), hold on
%         scatter(0.904475029229362,0.918744850782052,50,RGB,'fill','s'), hold on
    end
