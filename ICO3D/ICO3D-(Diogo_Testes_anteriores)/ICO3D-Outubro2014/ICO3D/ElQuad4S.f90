...
subroutine ElQuad4S(nel,Ke,el_ddisp,Finte)
    ...
    do i=1,npi_xi
        do j=1,npi_eta
            ...
            call MaterialPStress(iprops,nds,(p+1)*(q+1),props,Bloc,3,el_ddisp,stress(nel,cpi,:),strain(nel,cpi,:),&
                & dstrain(nel,cpi,:),dstress(nel,cpi,:),hard(nel,cpi),matD)
