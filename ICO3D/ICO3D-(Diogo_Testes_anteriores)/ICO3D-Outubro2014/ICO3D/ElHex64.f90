!------------------------------------------------------------------------------------------------------------
!
! General third-order hexaedral element with a 3x3x3 gaussian quadrature
!
...
subroutine ElHex64(nel,nelp,Ke,el_ddisp,Finte,inc)
    ...
    integer(4),parameter::npi_xi= 4, npi_eta = 4, npi_zeta = 4
