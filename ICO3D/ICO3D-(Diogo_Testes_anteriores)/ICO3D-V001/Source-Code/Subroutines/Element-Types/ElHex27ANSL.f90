...
!    
!    real(8)::shp,suma,uk,vk,wk,wei,sumw,A,B
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(5,(k2-1)*3+k3) = BNG(5,(k2-1)*3+k3) + (dRAdxii(k2,1)*jacA(3,k3) + dRAdxii(k2,3)*jacA(1,k3))*shpANS(1)
!                        end do
!                    end do
!                end if
!                
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(1,(k2-1)*3+k3) = BNG(1,(k2-1)*3+k3) + dRAdxii(k2,1)*jacA(1,k3)*shpANS(1)
!                        end do
!                    end do
!                endif
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(5,(k2-1)*3+k3) = BNG(5,(k2-1)*3+k3) + (dRAdxii(k2,1)*jacA(3,k3) + dRAdxii(k2,3)*jacA(1,k3))*shpANS(2)
!                        end do
!                    end do
!                end if
!                
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(1,(k2-1)*3+k3) = BNG(1,(k2-1)*3+k3) + dRAdxii(k2,1)*jacA(1,k3)*shpANS(2)
!                        end do
!                    end do
!                endif
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(5,(k2-1)*3+k3) = BNG(5,(k2-1)*3+k3) + (dRAdxii(k2,1)*jacA(3,k3) + dRAdxii(k2,3)*jacA(1,k3))*shpANS(3)
!                        end do
!                    end do
!                end if
!                
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(1,(k2-1)*3+k3) = BNG(1,(k2-1)*3+k3) + dRAdxii(k2,1)*jacA(1,k3)*shpANS(3)
!                        end do
!                    end do
!                endif
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(5,(k2-1)*3+k3) = BNG(5,(k2-1)*3+k3) + (dRAdxii(k2,1)*jacA(3,k3) + dRAdxii(k2,3)*jacA(1,k3))*shpANS(4)
!                        end do
!                    end do
!                end if
!                
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(1,(k2-1)*3+k3) = BNG(1,(k2-1)*3+k3) + dRAdxii(k2,1)*jacA(1,k3)*shpANS(4)
!                        end do
!                    end do
!                endif
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(5,(k2-1)*3+k3) = BNG(5,(k2-1)*3+k3) + (dRAdxii(k2,1)*jacA(3,k3) + dRAdxii(k2,3)*jacA(1,k3))*shpANS(5)
!                        end do
!                    end do
!                end if
!                
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(1,(k2-1)*3+k3) = BNG(1,(k2-1)*3+k3) + dRAdxii(k2,1)*jacA(1,k3)*shpANS(5)
!                        end do
!                    end do
!                endif
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(5,(k2-1)*3+k3) = BNG(5,(k2-1)*3+k3) + (dRAdxii(k2,1)*jacA(3,k3) + dRAdxii(k2,3)*jacA(1,k3))*shpANS(6)
!                        end do
!                    end do
!                end if
!                
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(1,(k2-1)*3+k3) = BNG(1,(k2-1)*3+k3) + dRAdxii(k2,1)*jacA(1,k3)*shpANS(6)
!                        end do
!                    end do
!                endif
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(6,(k2-1)*3+k3) = BNG(6,(k2-1)*3+k3) + (dRAdxii(k2,2)*jacA(3,k3) + dRAdxii(k2,3)*jacA(2,k3))*shpANS(7)
!                        end do
!                    end do
!                end if
!
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(2,(k2-1)*3+k3) = BNG(2,(k2-1)*3+k3) + dRAdxii(k2,2)*jacA(2,k3)*shpANS(7)
!                        end do
!                    end do
!                endif
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(6,(k2-1)*3+k3) = BNG(6,(k2-1)*3+k3) + (dRAdxii(k2,2)*jacA(3,k3) + dRAdxii(k2,3)*jacA(2,k3))*shpANS(8)
!                        end do
!                    end do
!                end if
! 
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(2,(k2-1)*3+k3) = BNG(2,(k2-1)*3+k3) + dRAdxii(k2,2)*jacA(2,k3)*shpANS(8)
!                        end do
!                    end do
!                endif
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(6,(k2-1)*3+k3) = BNG(6,(k2-1)*3+k3) + (dRAdxii(k2,2)*jacA(3,k3) + dRAdxii(k2,3)*jacA(2,k3))*shpANS(9)
!                        end do
!                    end do
!                end if
!
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(2,(k2-1)*3+k3) = BNG(2,(k2-1)*3+k3) + dRAdxii(k2,2)*jacA(2,k3)*shpANS(9)
!                        end do
!                    end do
!                endif
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(6,(k2-1)*3+k3) = BNG(6,(k2-1)*3+k3) + (dRAdxii(k2,2)*jacA(3,k3) + dRAdxii(k2,3)*jacA(2,k3))*shpANS(10)
!                        end do
!                    end do
!                end if
!                
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(2,(k2-1)*3+k3) = BNG(2,(k2-1)*3+k3) + dRAdxii(k2,2)*jacA(2,k3)*shpANS(10)
!                        end do
!                    end do
!                endif
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(6,(k2-1)*3+k3) = BNG(6,(k2-1)*3+k3) + (dRAdxii(k2,2)*jacA(3,k3) + dRAdxii(k2,3)*jacA(2,k3))*shpANS(11)
!                        end do
!                    end do
!                end if
!                
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(2,(k2-1)*3+k3) = BNG(2,(k2-1)*3+k3) + dRAdxii(k2,2)*jacA(2,k3)*shpANS(11)
!                        end do
!                    end do
!                endif
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(6,(k2-1)*3+k3) = BNG(6,(k2-1)*3+k3) + (dRAdxii(k2,2)*jacA(3,k3) + dRAdxii(k2,3)*jacA(2,k3))*shpANS(12)
!                        end do
!                    end do
!                end if
!                
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(2,(k2-1)*3+k3) = BNG(2,(k2-1)*3+k3) + dRAdxii(k2,2)*jacA(2,k3)*shpANS(12)
!                        end do
!                    end do
!                endif
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(4,(k2-1)*3+k3) = BNG(4,(k2-1)*3+k3) + (dRAdxii(k2,1)*jacA(2,k3) + dRAdxii(k2,2)*jacA(1,k3))*shpANS(13)
!                        end do
!                    end do
!                end if
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(4,(k2-1)*3+k3) = BNG(4,(k2-1)*3+k3) + (dRAdxii(k2,1)*jacA(2,k3) + dRAdxii(k2,2)*jacA(1,k3))*shpANS(14)
!                        end do
!                    end do
!                end if
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(4,(k2-1)*3+k3) = BNG(4,(k2-1)*3+k3) + (dRAdxii(k2,1)*jacA(2,k3) + dRAdxii(k2,2)*jacA(1,k3))*shpANS(15)
!                        end do
!                    end do
!                end if
!                !-------------------------------------------------------------------------------------------
...
!                    do k2=1,(p+1)*(q+1)*(w+1)
!                        do k3 =1,nds
!                            BNG(4,(k2-1)*3+k3) = BNG(4,(k2-1)*3+k3) + (dRAdxii(k2,1)*jacA(2,k3) + dRAdxii(k2,2)*jacA(1,k3))*shpANS(16)
!                        end do
!                    end do
!                end if
!                !-------------------------------------------------------------------------------------------
