...
subroutine GiDMesh()
    ...
    !---------------------------------------------------------------
    if(elcode == 'Hex8' .or. elcode == 'Hex8BBar' .or. elcode == 'Hex27' .or. elcode == 'Hex27BBar' .or. &
       elcode == 'Hex64' .or. elcode == 'Hex8ANS' .or. elcode == 'Hex27ANS' .or. elcode == 'Hex27EAS_PW' &
       .or. elcode == 'Hex27EAS' .or. elcode == 'Hex27SRI' .or. elcode == 'Hex27PVS' .or. elcode == 'Hex27PV' &
       .or. elcode == 'Hex27_ProjVol') then
        my_type = "Hexahedra"
        nodpelem = 8
    end if
