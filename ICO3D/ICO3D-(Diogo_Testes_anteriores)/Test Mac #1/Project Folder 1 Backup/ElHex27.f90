...
!----------------------------------------------------------------------------
! Comentado para teste de compilacao (NECESSITA ESTAR DESCOMENTADO!!!): Diogo                
!----------------------------------------------------------------------------
...
! Procurar linebreak para o compilardor da Absoft. Mandar apartir da dstrain para baixo !!!!!!!!!!
!                
